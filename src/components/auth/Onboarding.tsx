...
const mapContainerStyle = {
  width: "100%",
  height: "384px", // 96 * 4 = 384px (96 = h-24)
};
...
const LocationMap = ({
      ...
      if (initialLocation) {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(
            ...
            () => {
              setMapError("Geolocation permission denied. Using default location.");
              updateLocation(new google.maps.LatLng(defaultCenter.lat, defaultCenter.lng));
            },
            { timeout: 5000 }
          );
        } else {
  ...
  const updateLocation = (location: google.maps.LatLng) => {
  ...
  if (loadError) {
    return (
      <div className="h-96 flex flex-col items-center justify-center bg-gray-50 rounded-lg border border-red-200">
  ...
  const grantPartnerAccess = useCallback(async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Automatically proceed to next step after success
        setTimeout(() => {
          setStep((prev) => prev + 1);
          setAccessStatus("");
        }, 2000);
            ...
            <div className="space-y-6">
              ...
              <div className="border-t pt-6 mt-6">
                ...
                <LocationMap
                  ...
                  initialLocation={
                    userDetails.location.lat && userDetails.location.lng
                      ? {
                          lat: userDetails.location.lat,
                          lng: userDetails.location.lng,
                        }
                      : undefined
                  }
                />
