  ...
  const getPageInfo = () => {
    ...
    switch (path) {
      ...
      case "smeta":
        return {
          title: "Meta",
          subtitle: "Manage your Meta platform analytics",
        };
      case "swhatsapp":
        return {
          title: "WhatsApp",
          subtitle: "Manage your WhatsApp business analytics",
        };
      case "sweb":
        return {
          title: "Web",
      ...
      case "pipelines":
        return {
          title: "Pipelines",
          subtitle: "Manage your sales pipelines",
        };
      case "calls":
        return {
          title: "Calls",
          subtitle: "Manage your phone calls",
        };
      case "shopnow":
        return {
          title: "Shop Now",
