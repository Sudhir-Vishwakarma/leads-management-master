...
const templates = [
  {
    id: "1",
    name: "Welcome Offer",
    content: "Hi {name}, welcome! Get 20% OFF with code WELCOME20",
    hasImage: true,
  },
  {
    id: "2",
    name: "Flash Sale",
    content: "Final hours! 50% OFF everything today only.",
    hasImage: false,
  },
  {
    id: "3",
  ...
  },
  {
    ...
    content: "How was your experience? Share feedback:",
    hasImage: false,
  },
];
...
const WhatsApp = () => {
  ...
  const handleSendCampaign = () => {
    ...
    alert(
      `Campaign sent to ${
        contactLists.find((l) => l.id === selectedList)?.count
      } contacts!`
    );
  };
      ...
      <section className="p-6 bg-white rounded-xl shadow-md">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <button
            onClick={handleSendCampaign}
            disabled={true}
            className="flex items-center gap-2 px-8 py-3 rounded-lg text-white font-medium bg-gray-400 cursor-not-allowed"
          >
