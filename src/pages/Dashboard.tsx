        ...
        <div className="relative overflow-hidden group">
          <div className="marquee-single flex items-center gap-x-8 min-w-max animate-marquee">
            ...
            <span className="mx-4 text-green-600 font-medium">
              *** Wishes you all the best, Happy Deals! ***
            </span>
          </div>
        </div>
...
//   return (
//     <div className={`relative h-full ${flipData ? "perspective-1000" : ""}`}>
//       <div
...
//         {/* Back side - only for flip-enabled cards */}
//         {/* {flipData && (
//           <div
//             className={`absolute inset-0 flex flex-col justify-center items-center p-5 rounded-xl ${
//               colors.bg
//             } ${isFlipped ? "" : "hidden"}`}
...
//               <div
//                 className={`${colors.iconBg} rounded-lg p-2.5 mb-3 ${colors.iconColor}`}
//               >
//                 {flipData.icon}
//               </div>
//               <h3 className={`text-sm font-medium text-center ${colors.text}`}>
//                 {flipData.title}
//               </h3>
...
//         {flipData && (
//           <div
//             className={`absolute inset-0 flex items-center justify-between px-5 py-4 rounded-xl w-auto h-auto ${
//               colors.bg
//             } ${isFlipped ? "" : "hidden"}`}
//             style={{
