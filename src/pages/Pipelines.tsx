...
const Dashboard: React.FC = () => {
  ...
  // Facts array with titles and content
  const salesFacts = [
    {
      title: "5-24 Rule",
      content:
        "You can get up to 80%+ Sales Conversion, if contacted leads within 5 minutes & meeting done within 24–48 hrs. Update Remarks CRM within 5min to get more quality leads.",
      highlight: "*** STARZ Wishes you all the best, Happy Deals! ***",
    },
    {
      title: "Fact #1: Did you know",
      note: (
        <a
      ...
      content:
        "Best Day to Contact Leads – Wednesday or Thursday - Shouldn't we be planning our campaigns around follow up?",
    },
    {
      title: "Fact #2: Did you know",
      note: (
        <a
          href="https://hbr.org/2011/03/the-short-life-of-online-sales-leads"
          target="_blank"
      ...
      content:
        "Best Time of Day to Call Leads: 4-5PM - Other days work, but less well - are there other tasks Inside Sales can do?",
    },
    {
      title: "Fact #3: Did you know",
      note: (
        <a
          href="https://hbr.org/2011/03/the-short-life-of-online-sales-leads"
          target="_blank"
      ...
      content:
        "400% increase in Lead Response by Contacting Lead within First 5 Minutes - Have you contacted your initial lead?",
    },
    {
      title: "Fact #4: Did you know",
      note: (
        <a
          href="https://hbr.org/2011/03/the-short-life-of-online-sales-leads"
          target="_blank"
      ...
      content:
        "Chance of making Contact on 1st Attempt – 11% - Not at all surprised - we all shield our calls these days",
    },
    {
      title: "Fact #5: Did you know",
      note: (
        <a
          href="https://hbr.org/2011/03/the-short-life-of-online-sales-leads"
          target="_blank"
      ...
      content:
        "Chance of making Contact by the 6th Attempt – 90% - Persistence endears a prospect to a company",
    },
    {
      title: "Fact #6: Did you know",
      note: (
        <a
          href="https://hbr.org/2011/03/the-short-life-of-online-sales-leads"
          target="_blank"
      ...
      content:
        "% of Sales Reps trying 6+ Times – Less than 3% - Here's where the quick win could be - Most sales people will give up after three or four times",
    },
    {
      title: "Fact #7: Did you know",
      note: (
        <a
          href="https://hbr.org/2011/03/the-short-life-of-online-sales-leads"
          target="_blank"
      ...
      content:
        "Standard Sales-Marketing Banter... - The Leads from Marketing Suck! & The Follow Up from Sales is Crap!",
    },
  ];

  // Create duplicated array for seamless looping
  const salesFactsForMarquee = [...salesFacts, ...salesFacts];
  ...
  return (
    <div className="container mx-auto px-1 py-3">
      ...
      {/* Horizontal Marquee Slider for Sales Facts - Single Line */}
      <div
        className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-500 rounded-lg overflow-hidden mb-6 py-3 relative"
        onMouseEnter={() => setIsMarqueePaused(true)}
        onMouseLeave={() => setIsMarqueePaused(false)}
      >
        <div className="marquee-container w-full overflow-hidden">
          <div
            className={`marquee-content flex items-center py-1 whitespace-nowrap gap-x-6 ${
              isMarqueePaused ? "paused" : ""
            }`}
          >
            {salesFactsForMarquee.map((fact, index) => (
              <div
                key={index}
                className="marquee-item inline-flex items-center space-x-2 bg-blue-50 rounded-lg shadow-sm px-10 py-1 mr-[1000px]"
              >
                <FaRegLightbulb className="h-5 w-5 text-blue-500 flex-shrink-0" />
                <span className="font-medium text-blue-800">{fact.title}</span>
                {fact.note && (
                  <span className="text-blue-600 italic">{fact.note}</span>
                )}
                <span className="text-blue-700">{fact.content}</span>
                {fact.highlight && (
